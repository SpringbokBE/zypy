...
#define ufunc_reduce_all_f4_0_addr 0x40000000
...
#define ufunc_reduce_all_f4_0_ctrl_ap_start_rw(x) x ? (ufunc_reduce_all_f4_0_vaddr[0 >> 2] = ((x & 0x1) << 0)) : (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0x1 << 0))
#define ufunc_reduce_all_f4_0_ctrl_ap_done_r() (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0x1 << 1))
#define ufunc_reduce_all_f4_0_ctrl_ap_idle_r() (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0x1 << 2))
#define ufunc_reduce_all_f4_0_ctrl_ap_ready_r() (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0x1 << 3))
#define ufunc_reduce_all_f4_0_ctrl_reserved_1_r() (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0x7 << 4))
#define ufunc_reduce_all_f4_0_ctrl_auto_restart_rw(x) x ? (ufunc_reduce_all_f4_0_vaddr[0 >> 2] = ((x & 0x1) << 7)) : (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0x1 << 7))
#define ufunc_reduce_all_f4_0_ctrl_reserved_2_r() (ufunc_reduce_all_f4_0_vaddr[0 >> 2] & (0xffffff << 8))
#define ufunc_reduce_all_f4_0_gier_enable_rw(x) x ? (ufunc_reduce_all_f4_0_vaddr[4 >> 2] = ((x & 0x1) << 0)) : (ufunc_reduce_all_f4_0_vaddr[4 >> 2] & (0x1 << 0))
#define ufunc_reduce_all_f4_0_gier_reserved_r() (ufunc_reduce_all_f4_0_vaddr[4 >> 2] & (0x7fffffff << 1))
#define ufunc_reduce_all_f4_0_ip_ier_chan0_int_en_rw(x) x ? (ufunc_reduce_all_f4_0_vaddr[8 >> 2] = ((x & 0x1) << 0)) : (ufunc_reduce_all_f4_0_vaddr[8 >> 2] & (0x1 << 0))
#define ufunc_reduce_all_f4_0_ip_ier_chan1_int_en_rw(x) x ? (ufunc_reduce_all_f4_0_vaddr[8 >> 2] = ((x & 0x1) << 1)) : (ufunc_reduce_all_f4_0_vaddr[8 >> 2] & (0x1 << 1))
#define ufunc_reduce_all_f4_0_ip_ier_reserved_r() (ufunc_reduce_all_f4_0_vaddr[8 >> 2] & (0x3fffffff << 2))
#define ufunc_reduce_all_f4_0_ip_isr_chan0_int_st_r() (ufunc_reduce_all_f4_0_vaddr[12 >> 2] & (0x1 << 0))
#define ufunc_reduce_all_f4_0_ip_isr_chan1_int_st_r() (ufunc_reduce_all_f4_0_vaddr[12 >> 2] & (0x1 << 1))
#define ufunc_reduce_all_f4_0_ip_isr_reserved_r() (ufunc_reduce_all_f4_0_vaddr[12 >> 2] & (0x3fffffff << 2))
#define ufunc_reduce_all_f4_0_ap_return_ap_return_r() (ufunc_reduce_all_f4_0_vaddr[16 >> 2] & (0xffffffff << 0))
#define ufunc_reduce_all_f4_0_args_args_w(x) (ufunc_reduce_all_f4_0_vaddr[24 >> 2] = ((x & 0xffffff) << 0))
#define ufunc_reduce_all_f4_0_args_reserved_r() (ufunc_reduce_all_f4_0_vaddr[24 >> 2] & (0xff << 24))
...
#define init()\
    ...
    volatile unsigned int *ufunc_reduce_all_f4_0_vaddr = (volatile unsigned int *) mmap(NULL, 65535, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0x40000000);\
    close(fd);

#define exit()\
    munmap((unsigned int *) axi_dma_0_vaddr, 65535);\
    munmap((unsigned int *) axi_dma_1_vaddr, 65535);\
    munmap((unsigned int *) ufunc_reduce_all_f4_0_vaddr, 65535);\
