...
gdl:np:np_arctan2_arcsinh_f4_combi_hw:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: np_arctan2_arcsinh_f_0, and set properties
  set np_arctan2_arcsinh_f_0 [ create_bd_cell -type ip -vlnv gdl:np:np_arctan2_arcsinh_f4_combi_hw:1.0 np_arctan2_arcsinh_f_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins np_arctan2_arcsinh_f_0/X1]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins np_arctan2_arcsinh_f_0/X2]
  ...
  connect_bd_intf_net -intf_net np_arctan2_arcsinh_f_0_OUT_r [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM] [get_bd_intf_pins np_arctan2_arcsinh_f_0/OUT_r]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs np_arctan2_arcsinh_f_0/s_axi_AXILiteS/Reg] -force
