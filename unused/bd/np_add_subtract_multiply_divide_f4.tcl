...
gdl:np:np_add_subtract_multiply_divide_f4_hw:1.0\
...
proc create_root_design { parentCell } {
  ...
  set np_add_subtract_mult_0 [ create_bd_cell -type ip -vlnv gdl:np:np_add_subtract_multiply_divide_f4_hw:1.0 np_add_subtract_mult_0 ]
