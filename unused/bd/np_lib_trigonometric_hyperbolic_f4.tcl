...
gdl:np:np_lib_trigonometric_f4_hw:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: np_lib_trigonometric_0, and set properties
  set np_lib_trigonometric_0 [ create_bd_cell -type ip -vlnv gdl:np:np_lib_trigonometric_f4_hw:1.0 np_lib_trigonometric_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins np_lib_trigonometric_0/x1s]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins np_lib_trigonometric_0/x2s]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_1_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins ila_1/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net np_lib_trigonometric_0_outs [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM] [get_bd_intf_pins np_lib_trigonometric_0/outs]
connect_bd_intf_net -intf_net [get_bd_intf_nets np_lib_trigonometric_0_outs] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM] [get_bd_intf_pins ila_2/SLOT_0_AXIS]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs np_lib_trigonometric_0/s_axi_AXILiteS/Reg] -force
