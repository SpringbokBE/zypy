...
#
# gain.tcl: Tcl script for re-creating project 'gain'
#
# Generated by Vivado on Mon Feb 01 20:51:33 +0100 2021
...
#
# 1. This project restoration tcl script (gain.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Gerbrand/Code/thesis/block_designs/gain/gain.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
...
set files [list \
 [file normalize "${origin_dir}/gain.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  set gain_0 [ create_bd_cell -type ip -vlnv ugent:gdl:gain:1.0 gain_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins gain_0/inStream]
  ...
  connect_bd_intf_net -intf_net gain_0_outStream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins gain_0/outStream]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins gain_0/s_axi_CRTL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net gain_0_interrupt [get_bd_pins gain_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins gain_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins gain_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gain_0/s_axi_CRTL_BUS/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.738247",
   "Default View_TopLeft":"0,-27",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:9.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1480 -y 80 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1480 -y 100 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 270 -y 140 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 3 -x 1060 -y 380 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 700 -y 530 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 270 -y 330 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 2 -x 700 -y 260 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -x 1350 -y 440 -defaultsOSRD
preplace inst gain_0 -pg 1 -lvl 3 -x 1060 -y 570 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 40 430 510 670 870
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 20 500
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 530J 110 860
preplace netloc gain_0_interrupt 1 3 1 1250 460n
preplace netloc axi_dma_0_mm2s_introut 1 3 1 N 420
preplace netloc axi_dma_0_s2mm_introut 1 3 1 N 440
preplace netloc xlconcat_0_dout 1 0 5 20 10 NJ 10 NJ 10 NJ 10 1440
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 520 150n
preplace netloc axi_dma_0_M_AXI_MM2S 1 1 3 540 70 N 70 1250
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 N 540
preplace netloc processing_system7_0_FIXED_IO 1 1 4 510 100 N 100 N 100 N
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 850 330n
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 2 890 660 1240
preplace netloc gain_0_outStream 1 2 2 880 670 1230
preplace netloc processing_system7_0_DDR 1 1 4 N 90 N 90 N 90 1450
preplace netloc axi_dma_0_M_AXI_S2MM 1 1 3 550 80 N 80 1230
preplace netloc axi_mem_intercon_M00_AXI 1 0 3 40 30 N 30 850
levelinfo -pg 1 0 270 700 1060 1350 1480
pagesize -pg 1 -db -bbox -sgen 0 0 1600 680
"
}
