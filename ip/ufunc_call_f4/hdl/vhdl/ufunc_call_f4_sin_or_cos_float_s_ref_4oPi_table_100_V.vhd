...
entity ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V_rom is 
...
entity ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V is
    generic (
...
architecture arch of ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V is
    component ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V_rom_U :  component ufunc_call_f4_sin_or_cos_float_s_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
