/**
 *  @file    test_np_add_subtract_multiply_divide_f4.cc
...
int main()
{
	...
	np_add_subtract_multiply_divide_f4_sw(x1, x2, out_sw, LEN, 0x00);
	std::cout << "Running hardware implementation...\n";
	np_add_subtract_multiply_divide_f4_hw(X1, X2, OUT, LEN, 0x00);
	...
	std::cout << "Running software implementation...\n";
	np_add_subtract_multiply_divide_f4_sw(x1, x2, out_sw, LEN, 0x01);
	std::cout << "Running hardware implementation...\n";
	np_add_subtract_multiply_divide_f4_hw(X1, X2, OUT, LEN, 0x01);
	...
	std::cout << "Running software implementation...\n";
	np_add_subtract_multiply_divide_f4_sw(x1, x2, out_sw, LEN, 0x02);
	std::cout << "Running hardware implementation...\n";
	np_add_subtract_multiply_divide_f4_hw(X1, X2, OUT, LEN, 0x02);
	...
	std::cout << "Running software implementation...\n";
	np_add_subtract_multiply_divide_f4_sw(x1, x2, out_sw, LEN, 0x03);
	std::cout << "Running hardware implementation...\n";
	np_add_subtract_multiply_divide_f4_hw(X1, X2, OUT, LEN, 0x03);
