...
proc create_root_design { parentCell } {
  ...
  set matmul_1 [ create_bd_cell -type ip -vlnv ugent:gdl:matmul:0.1 matmul_1 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins matmul_1/in_stream]
  ...
  connect_bd_intf_net -intf_net matmul_0_out_stream [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins matmul_0/out_stream]
  connect_bd_intf_net -intf_net matmul_1_out_stream [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins matmul_1/out_stream]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins matmul_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matmul_0/s_axi_AXILiteS/Reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matmul_1/s_axi_AXILiteS/Reg] -force
