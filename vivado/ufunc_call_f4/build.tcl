...
create_project ufunc_call_f4 "${workdir}/bd/ufunc_call_f4" -part xc7z020clg400-1
...
startgroup
create_bd_cell -type ip -vlnv zypy:hls:ufunc_call_f4:1.0 ufunc_call_f4_0
endgroup
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/processing_system7_0/FCLK_CLK0 (100 MHz)} Clk_slave {Auto} Clk_xbar {/processing_system7_0/FCLK_CLK0 (100 MHz)} Master {/processing_system7_0/M_AXI_GP0} Slave {/ufunc_call_f4_0/s_axi_control} ddr_seg {Auto} intc_ip {/ps7_0_axi_periph} master_apm {0}}  [get_bd_intf_pins ufunc_call_f4_0/s_axi_control]
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins ufunc_call_f4_0/in1_s]
connect_bd_intf_net [get_bd_intf_pins ufunc_call_f4_0/out1_s] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
connect_bd_intf_net [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins ufunc_call_f4_0/in2_s]
connect_bd_intf_net [get_bd_intf_pins ufunc_call_f4_0/out2_s] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files "${workdir}/bd/ufunc_call_f4/ufunc_call_f4.srcs/sources_1/bd/design_1/design_1.bd"] -top
add_files -norecurse "${workdir}/bd/ufunc_call_f4/ufunc_call_f4.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v"
