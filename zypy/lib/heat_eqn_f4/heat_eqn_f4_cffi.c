...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 11), // float()(unsigned int, unsigned int, unsigned int)
...
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION, 12), // void()(unsigned int, unsigned int, unsigned int, unsigned int)
...
static void _cffi_d_filter_avg_f4(unsigned int x0, unsigned int x1, unsigned int x2, unsigned int x3)
{
  filter_avg_f4(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_filter_avg_f4(PyObject *self, PyObject *args)
{
  unsigned int x0;
  unsigned int x1;
  unsigned int x2;
  ...
  if (!PyArg_UnpackTuple(args, "filter_avg_f4", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_filter_avg_f4 _cffi_d_filter_avg_f4
#endif

static float _cffi_d_sad_reduce_all_f4(unsigned int x0, unsigned int x1, unsigned int x2)
{
  return sad_reduce_all_f4(x0, x1, x2);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_sad_reduce_all_f4(PyObject *self, PyObject *args)
{
  unsigned int x0;
  unsigned int x1;
  unsigned int x2;
  ...
  if (!PyArg_UnpackTuple(args, "sad_reduce_all_f4", 3, 3, &arg0, &arg1, &arg2))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = sad_reduce_all_f4(x0, x1, x2); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_sad_reduce_all_f4 _cffi_d_sad_reduce_all_f4
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "filter_avg_f4", (void *)_cffi_f_filter_avg_f4, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 5), (void *)_cffi_d_filter_avg_f4 },
  { "sad_reduce_all_f4", (void *)_cffi_f_sad_reduce_all_f4, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_sad_reduce_all_f4 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_heat_eqn_f4_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_heat_eqn_f4_cffi(void) { return NULL; }
#  else
     initheat_eqn_f4_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_heat_eqn_f4_cffi(void)
{
  return _cffi_init("heat_eqn_f4_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initheat_eqn_f4_cffi(void)
{
  _cffi_init("heat_eqn_f4_cffi", 0x2601, &_cffi_type_context);
}
#endif
