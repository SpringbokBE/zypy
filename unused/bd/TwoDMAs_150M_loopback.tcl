...
################################################################
# This is a generated script based on design: TwoDMAs_150M_loopback
#
...
# source TwoDMAs_150M_loopback_script.tcl
...
set design_name TwoDMAs_150M_loopback
...
proc create_root_design { parentCell } {
  ...
  set axis_sink_0 [ create_bd_cell -type ip -vlnv zypy:hls:axis_sink:0.15 axis_sink_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins axis_sink_0/in_s]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_2_M_AXIS [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_2_M_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_2_M_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axis_sink_0/s_axi_control/Reg] -force
