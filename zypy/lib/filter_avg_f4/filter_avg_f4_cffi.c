...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 6), // void()(unsigned int, unsigned int, unsigned int, unsigned int)
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "filter_avg_f4", (void *)_cffi_f_filter_avg_f4, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_filter_avg_f4 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_filter_avg_f4_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_filter_avg_f4_cffi(void) { return NULL; }
#  else
     initfilter_avg_f4_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_filter_avg_f4_cffi(void)
{
  return _cffi_init("filter_avg_f4_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initfilter_avg_f4_cffi(void)
{
  _cffi_init("filter_avg_f4_cffi", 0x2601, &_cffi_type_context);
}
#endif
